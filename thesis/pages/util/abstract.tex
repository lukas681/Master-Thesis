...
On the positive side, we extend a technique proposed by Alber et al.~\cite{Alber2004} for \dom to construct a linear kernel of size $\kernelsize k$ for \sdom on planar graphs.
