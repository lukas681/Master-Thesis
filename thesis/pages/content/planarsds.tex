...
\begin{figure}[!ht]
    ...
    \end{equation*}
    \caption[Structure of the Proofs]{\textit{The plan for obtaining a linear kernel for \psdom. Starting with the reduction rules in {\setulcolor{green}\ul{green}} we will derive the number of vertices inside and outside of a $vw$-region. Lemmas to bind the number of vertices are marked in {\setulcolor{MATHAYELLOW}\ul{yellow}}
    }}\label{fig:overview}
\end{figure}
...
\cref{fig:overview} depicts these three goals in {\setulcolor{MATHAYELLOW}\ul{yellow}}.
