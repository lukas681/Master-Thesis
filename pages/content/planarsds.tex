...
\begin{figure}[]
    ...
    \textit{Left: $\{d_1, d_2\}$ with $d_2 \in N_2(v,w)$ form the only minimum semitotal dominating set. Right: $d_1 \in N_1(v,w)$ and $d_2 \in N_3(v,w)$ optimal.}
...
\begin{figure}[!ht]
    ...
    There are two regions between $d_2$ and $d_1$ (\textbf{\textcolor{FILLPURPLE}{purple}} and \textbf{\textcolor{FILLDARKBLUE}{pink}}), one region between $d_1$ and $d_3$ (\textbf{\textcolor{FILLDARKBLUE}{purple}}) and one region between $d_2$ and $d_3$ (\textbf{\textcolor{FILLGREEN}{green}}). 
