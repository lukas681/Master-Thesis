...
For a formal definition, we will now give a series of definitions that are based on those given by Garnero and Stau (\cite{Garnero2014}) and will lead toward a clean defintion of a \textit{region}.

%It might be interesting to note that the authors of \cite{Garnero2017} have revised their or\iginal definitions to set the basis for a more formal analysis.
