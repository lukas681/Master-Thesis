...
\begin{lemma}\label{lemma:nonecover}
    ...
    For any $vw$-regions $R \in \mathfrak{R}$,  $\abs{N_1(v,w) \cap V(R)} \leq 4$ and these vertices lay exactly on the boundary $\partial R$ of $R$. 
\end{lemma}
\begin{proof}
The proof directly follows from \cite[Proposition 2, Revision 2018]{Garnero2019}, because every \tdom is also \sdom. Actually, this claim also holds for \dom in Intuitively, this statement says that every $N_(v,w)$
\end{proof}
