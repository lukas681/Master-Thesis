...
Alber et al. (\cite{Alber2004}) introduced a novel approach on how to look at planar graphs. In their analysis they gave an construtive algorithms on how to decompose a planar graph into local areas which they call ``regions''. As Garnero and Stau (\cite{Garnero2018}) seized these results in their analysis of \ptdom. Using this as a basis, we will transfer them to \sdom as well.  
