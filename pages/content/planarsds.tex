...
Observe that in the first case, we can assume that no case of \cref{rgl:rtwo} has been applied, but the claim is a direct consequence of the assumption $\Dv \neq \emptyset$ and $\Dw \neq \emptyset$. If \cref{case:c2} \cref{case:c3} has been applied $N_{2,3}(v,w)$ gets reduced and the second case can be applied.

\textbf{STOP STOP STOP ---  FROM HERE ERVERYTHING IS CURRENTLY IN PROGRESS -- :)}
