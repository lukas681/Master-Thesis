...
\begin{rgl}\label{rgl:rtwo}
    ...
    \begin{caseof}
        ...
        \end{itemize}
        \case{if $\Dv \neq  \emptyset$ and $D_w \neq \emptyset$}: Added for sake of completeness. Do nothing.
...
Note that if we would not distinguish between these two cases and just add one intermediate vertex, we would possibly generate wrong solutions, because $v$ could always witness $w$.
