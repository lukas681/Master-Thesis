...
If two vertices $v$ and $w$ share enough neighbors with each other at least one of them must be in a solution to dominate all of them. 

We know that $v$ witnesses $w$ (and vice versa) and therefore, we can always semitotal dominate with at most to vertices. 

However sometimes choosing two of the shared vertices yields a better solution than $v$ and $w$: One common neighbor is already enough to dominate $v$ and $w$ and can be witnesses by a  
