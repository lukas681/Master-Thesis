...
\begin{figure}[!ht]
    ...
    \end{equation*}
\caption[Constructing a chordal $G'$]{\textit{Constructing a chordal $G'$ from the chordal graph $P_4$ by adding a $K_5$, connecting its vertices pairwise to $G$ and adding some auxiliary vertices to preserve chordality.}}
\end{figure}
...
\begin{proof}
    ...
    Ann example is shown in \cref{fig:construct-chordal-reduction}
