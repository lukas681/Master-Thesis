...
\subsection{Previous Results for Planar Dominating Set}
After Alber et al. introduced their kernelization technique in \cite[]{Alber2004}, a series of similar results emerged transfering these results to other variants of dominating set as well. The following table gives an overview about some different variants of dominating set:

\begin{table}[]
\begin{tabular}{ccc}
\textbf{Problem} & \textbf{Best Known Kernel} & \textbf{Source} \\
\dom &  $67k$ & \cite{Diekert2005}\tablefootnote{There is also a masters thesis claiming a bound of 43k \cite{Halseth2016}, but a conference or journal version was not found.}\\
\tdom &  $410k$ & \cite{Garnero2018}\tablefootnote{Improved their own results from first $694$ \cite{Garnero2014}} \\
\rbdom &  $43k$ & \cite{Garnero2017a} \\
\cdom & $130k$  & \cite{Luo2013} \\
\eddom & $14k$  & \cite[p. 375 - 386, (2)]{Arge2007} \\
\efdom &  $84k$ & \cite[p. 375 - 386, (4)]{Arge2007} \\
\dirdom &  ?  & \cite{Alber2006}  \\
\sdom & & This Thesis \\
\end{tabular}
\end{table}

Furthermore, it is worth mentioning that the technique was further developed to a number of meta theorems:
