...
\subsection{Regions in Planar Graph}
...
\begin{definition}
    Let \G be a plane graph and let $v,w \in V$ be two distinct vertices. A $vw$-region is a closed subset of the plane such that:
    \begin{enumerate}
...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item $V(R) \{v,w\} \subseteq N(v) \cap N(w)$.
    \end{enumerate}
\end{definition}
