...
We now carefully transfer our definitions given in \cref{ch:npc} to the parameterized setting. 

The idea is to transfer the concepts of \NP-hardness and reductions from the classical setting to the parameterized world.
...
It is strongly believed that $\FPT \subsetneq W[t]$ and therefore, we do not expect the existence of an algorithm solving any \Wt-hard problem in fpt time.
