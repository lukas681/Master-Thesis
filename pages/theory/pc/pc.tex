...
\begin{definition}[Output size of a Preprocessing Algorithm {\cite[p. 18]{Cygan2015}}] The output size of a preprocessing algorithms $\mathfrak{A}$ is defined as 
...
The following lemma \Cref{lemma:fptiskernel} shows the relation between the complexity class \FPT and a kernelization algorithm. 
...
\begin{lemma}[{\cite{Cygan2015}}]\label{lemma:fptiskernel}
...
\subsection{Fixed Parameter Intractability}
It is natural to ask whether all parametrized problems are fpt as well.
