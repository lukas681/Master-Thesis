...
\begin{center}
    ...
    % Probably missing according to Henning: https://core.ac.uk/download/pdf/82724702.pdf LINE GRAPH Distance Heriditary Graph?, 
...
\resizebox{1.0\textwidth}{!}{
    \begin{tabularx}{1.8\textwidth}{lllllll}
        ...
        dually chordal                        & \multicolumn{2}{c}{\Pt \cite{Brandstaedt1998} }         & Unkown                                             & Unkown & ?                          &                                                                            \\
       ...
       block                        &                                                      \multicolumn{2}{c}{\Pt \cite{Farber1984} }                                          & \multicolumn{2}{c}{\Pt \cite{Henning2022}}              & \multicolumn{2}{c}{\Pt \cite{Chang1989}}                                                                       \\
        ...
        planar                                & \NPcs (Sources!)                                        & \FPT \cite{Alber2004}                        & \NPcs                                                   & \FPT \textbf{(this)}                       & \NPcs                                        & \FPT \cite{Garnero2018}     \\
        
        undirected path                                & \NPcs \cite{Booth1982}                                   & \FPT \cite{Figueiredo1990} & \NPcs \cite{Henning2022}  & Unkown                     & \NPcs \cite{Lan2014}                         & Unkown  (?)                     \\

        interval                  & \multicolumn{2}{c}{\Pt \cite{Chang1998a}}                                          & \multicolumn{2}{c}{\Pt \cite{Pradhan2021}} &                                         \multicolumn{2}{c}{\Pt \cite{Bertossi1986}}                       \\
