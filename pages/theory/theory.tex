...
\resizebox{0.95\textwidth}{!}{
    \begin{tabularx}{1.4\textwidth}{lcccccc}
        ...
        bipartite               & \NPcs \cite{Bertossi1984}                             &  \WTWOhs                                 & \NPcs \cite{Henning2019}                              & & \NPcs \cite{Pfaff1983} &   \\
        line graph of bipartite & \NPcs \cite{Korobitsin1992}                             &                                    & \NPcs \cite{Galby2020}                              &  & \NPcs \cite{McRae1995}  &   \\
        circle                  & \NPcs \cite{Keil1993}                             & ?                                    & \NPcs                              &  &  \NPcs \cite{McRae1995} &   \\
        split                   & \NPcs \cite{Bertossi1984}                             & \WTWOhs                                    & \NPcs \cite{Henning2019}                              &  & \NPcs \cite{}  &   \\
        chordal bipartite       & \NPcs                             &                                    & \NPcs \cite{Henning2019}                             &  & \Pt  &   \\
        dually chordal          & \multicolumn{2}{c}{\Pt \cite{Brandstaedt1998} }           &     ?                          &                           &   ?   &            \\
        strongly chordal        & \multicolumn{2}{c}{\Pt \cite{} }           &     \multicolumn{2}{c}{\Pt \cite{Tripathi2021}}                            &   XXX   &            \\
        AT-free                 & \multicolumn{2}{c}{\Pt \cite{Kratsch2000}}                                & ?                            &                               & \multicolumn{2}{c}{\Pt \cite{Kratsch2000}} \\
        tolerance               & \multicolumn{2}{c}{\Pt}                                &                TODO             & TODo                               & TODO   & TODO \\
        cocopmarability         & \multicolumn{2}{c}{TODO}                                &                TODO             & TODo                               & TODO  & TODO \\
...
\begin{figure}
        ...
        \caption{\textit{Computational Complexity of \sdom.}}
