...
\resizebox{0.95\textwidth}{!}{
    \begin{tabularx}{1.2\textwidth}{lcccccc}
        %TODO \arrayrulecolor{TUMAccentBlue}
        \toprule
        ...
        bipartite               & \NPcs                             & d                                  & \NPcs                              & Easdffasd & Fasdf  & Gasdf  \\
        line graph of bipartite & \NPcs                             &                                    & \NPcs                              & Easdffasd & Fasdf  & Gasdf  \\
        circle                  & \NPcs                             &                                    & \NPcs                              & Easdffasd & Fasdf  & Gasdf  \\
        split                   & \NPcs                             & \WTWOhs                                    & \NPcs                              & Easdffasd & Fasdf  & Gasdf  \\
        chordal bipartite       & \NPcs                             &                                    & \NPcs                              & Easdffasd & Fasdf  & Gasdf  \\
        dually chordal          & \multicolumn{2}{c}{\Pt}           & Dasdf                              & Easdffasd                          & Fasdf     & Gasdf           \\
        AT-free                 & \multicolumn{2}{c}{\Pt}                                & Casdfsd                            & Dasdf                              & Easdffasd & Fasdf\\
        tolerance               & \multicolumn{2}{c}{\Pt}                                & Casdfsd                            & Dasdf                              & Easdffasd & Fasdf\\
        \midrule
        bounded clique-width    & \multicolumn{2}{c}{\Pt}                                &  \multicolumn{2}{c}{\Pt}                               &  \multicolumn{2}{c}{\Pt} \\
        bounded mim-width       & \multicolumn{2}{c}{\Pt}                                &  \multicolumn{2}{c}{\Pt}                               &  \multicolumn{2}{c}{\Pt} \\
        \midrule
...
\end{center}
        ...
        \resizebox{1.0\textwidth}{!}{
         \input{fig/graphviz/graphclasses.tikz}
        }
        \caption{\textit{Currently, stilla test}}
