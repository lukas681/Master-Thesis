...
If not menioned otherwise, parameterizedation by solution size.
...
\begin{center}
    ...
    % Interesting Survey about all graph classes
    % Probably missing according to Henning: https://core.ac.uk/download/pdf/82724702.pdf LINE GRAPH, INTERVAL GRAPH, PERMUTATION GRAPHm. Distance Heriditary Graph?, k-polygon graph, partial k tree<

    % Add girth results: https://link.springer.com/content/pdf/10.1007/978-1-4614-6525-6.pdf?pdf=button

    % TODO: Line Graph of Bipartite unkniwn
    % Proof not available for split graph. Nothing found for split graphs

% Reduction from \cite{Change1998} to show NP hardness works preserves solution size and hence is also a FPT reduction!
% TODO search for a better source for NP completeness total domination 
...
\resizebox{1.0\textwidth}{!}{
    \begin{tabularx}{1.8\textwidth}{lllllll}
        ...
        %         split                                    & \NPcs \cite{Bertossi1984}                               & \WTWOhs \cite{Raman2008}                     & \NPcs \cite{Henning2019}                                & \WTWOhs (this) & \NPcs \cite{Laskar1983}                      & \WTWOhs                              \\
        ...
        tolerance                             & \multicolumn{2}{c}{\Pt Source!}                         & Unknown                                      & Unkown                                                  & Unknown                    & Unknown                                                                    \\
        
        % cocomperability                          & \multicolumn{2}{c}{\Pt \cite{Kratsch1993}}                                & Unknwon (?)                                         & Unknown ?                                                    & \multicolumn{2}{c}{\Pt \cite{Kratsch1993}}                                                                       \\
       block                        &                                                      \multicolumn{2}{c}{\Pt \cite{Farber1984} }                                          & \multicolumn{2}{c}{\Pt \cite{Henning2022}}              & \multicolumn{2}{c}{\Pt \cite{Chang1989}}                                                                       \\
        
        planar                                & \NPcs (Sources!)                                        & \FPT \cite{Alber2004}                        & \NPcs                                                   & \FPT                       & \NPcs                                        & \FPT \cite{Garnero2018}     \\
        
        undirected path                                & \NPcs \cite{Booth1982}                                   & \FPT \cite{Figueiredo1990} & \NPcs \cite{Henning2022}  & Unkown                     & \NPcs \cite{Lan2014}                         & Unkown  (?)                     \\
...
\begin{figure}
    ...
    \caption{\textit{Computational Complexity of \sdom. TODO: Block Graph, Directed Path Graph, line Graph, Chordal Perfect graph (??), AT-free Polytime sovable, make general and then to perfect, planar circle ..., Check direction circular k tapezoid}}
