...
\resizebox{1.0\textwidth}{!}{
    \begin{tabularx}{1.6\textwidth}{lllllll}
        ...
        circle                  & \NPcs \cite{Keil1993}                             & \WONEhs \cite{Bousquet2012}                                     & \NPcs \cite{Kloks2021}                              &  &  \NPcs \cite{McRae1995} &   \\

        split                   & \NPcs \cite{Bertossi1984}                             & \WTWOhs                                    & \NPcs \cite{Henning2019}                              &  \WTWO (this) & \NPcs \cite{Laskar1983}  &   \\
        ...
        strongly chordal        & \multicolumn{2}{c}{\Pt \cite{} }           &     \multicolumn{2}{c}{\Pt \cite{Tripathi2021}}                            &   \NPcs \cite{Farber194}   &            \\
