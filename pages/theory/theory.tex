...
Our results are highlighted.

% TODO: Make table out of that
All complexity results are shown in \cref{tab:complexities}.
...
\resizebox{1.0\textwidth}{!}{
    \begin{tabularx}{1.8\textwidth}{lllllll}
        ...
        chordal                               & \NPcs \cite{Booth1982}                                  & \WTWOhs \cite{Raman2008}                     & \NPcs \cite{Henning2019}                                & \WTWOhs (this)               & \NPcs \cite{Laskar1983}                      &                             \\
       ...
       block                        &                                                      \multicolumn{2}{c}{\Ptt \cite{Farber1984} }                                          & \multicolumn{2}{c}{\Ptt \cite{Henning2022}}              & \multicolumn{2}{c}{\Ptt \cite{Chang1989}}                                                                       \\
        ...
        planar                                & \NPcs (Sources!)                                        & \FPTt \cite{Alber2004}                        & \NPcs                                                   & \FPTt \textbf{(this)}                       & \NPcs                                        & \FPTt \cite{Garnero2018}     \\
