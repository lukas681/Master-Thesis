...
\subsection{Graph Classes and Special Graphs}
...
The complete graph $K_3$ on three vertices is called \underline{triangle}
\end{definition}
...
A graph \G is \underline{chordal} (or \textit{triangulated})if each of its cycles of length at least four has a chord. In other words, it contains no induced cycle other than triangles.
%TODO Forbitten minor characterization
