...
For example, de Jaenosch attempted in 1862 to solve the minimum number of queens required to fully cover an $n \times n$ -chessboard \cite{Jaenisch1862}. Because of the immense amount of publicationss related to domination, Haynes, Hedetniemi, and Slater started a comprehensive survey of the literature in graphs \cite{Haynes1998, Haynes1998b}. 
...
\textit{Semitotal domination} was introduced by Goddard, Henning and McPillan \cite{Goddard2014}. 

Since then many papers have 
Henning started a new approach 
